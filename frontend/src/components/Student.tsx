...
function Student() {
    ...
    const columns: GridColDef[] = [
        ...
        {field: "Collegeyear", headerName: "ชั้นปี", width: 60 ,valueFormatter: (params) => params.value.Name, },
        {field: "Faculty", headerName: "สำนักวิชา", width: 150 ,valueFormatter: (params) => params.value.Name,},
        {field: "Teacher", headerName: "อาจารย์ที่ปรึกษา", width: 120 ,valueFormatter: (params) => params.value.Name,},
        {field: "Date_of_birth", headerName: "วันเดือนปีเกิด", width: 100 },
